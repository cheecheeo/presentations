...
pandoc -t beamer -f markdown flawless_feature_release_at_enterprise_internet_companies.markdown -o flawless_feature_release_at_enterprise_internet_companies.pdf
